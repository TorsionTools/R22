...
namespace TorsionTools.Commands
{
    ...
    class ViewDeleteUnplacedViews : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            //Create a new instance of the Unplaced View form.
            WPF.ViewDeleteUnplacedWPF form = new WPF.ViewDeleteUnplacedWPF(doc);
