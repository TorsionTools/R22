...
namespace TorsionTools.Commands
{
    ...
    class ExternalViews : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            //Create a new instance of the ExternalViewSelectionForm form and pass the current document as variables
            using (Forms.ExternalViewSelectionForm form = new Forms.ExternalViewSelectionForm(doc))
            {
